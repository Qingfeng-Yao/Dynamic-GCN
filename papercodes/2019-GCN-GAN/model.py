...
class Generator(nn.Module):
    ...
    def forward(self, in_shots):
        ...
        eye = torch.eye(node_num).cpu().unsqueeze(0).unsqueeze(0).expand(batch_size, window_size, node_num, node_num)
        ...
        nodes = torch.rand(batch_size, window_size, node_num, self.in_features).cpu()
